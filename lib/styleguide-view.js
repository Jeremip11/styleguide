    ...
    return (
      <div className='styleguide pane-item native-key-bindings' tabIndex='-1'>
        <header className='styleguide-Header'>
          <h1 className='styleguide-Title'>Styleguide</h1>
          <p className='styleguide-Description'>This exercises all UI components and acts as a styleguide.</p>

          <div className='styleguide-Controls ButtonGroup'>
            <button className='ButtonGroup-item Button' onclick={() => this.collapseAll()}>Collapse All</button>
            <button className='ButtonGroup-item Button' onclick={() => this.expandAll()}>Expand All</button>
          </div>
        </header>
        ...
        <main className='styleguide-Sections'>
          ...
          <StyleguideSection onDidInitialize={this.didInitializeSection.bind(this)} name='inputs' title='Inputs'>
            ...
            <h2>Text Inputs</h2>
            {this.renderExampleHTML(dedent`
              <input class='TextInput' type='text' placeholder='Text'>
            ...
            <h2>Controls</h2>
            {this.renderExampleHTML(dedent`
              <label class='Label'><input class='Radio' type='radio' name='radio'> Radio</label>
              <label class='Label'><input class='Radio' type='radio' name='radio' checked> Radio</label>
              <label class='Label'><input class='Checkbox' type='checkbox' checked> Checkbox</label>
              <label class='Label'><input class='Switch' type='checkbox' checked> Switch</label>
              <input class='Slider' type='range'>
            `)}

            <h2>Misc</h2>
            {this.renderExampleHTML(dedent`
              <input class='ColorPicker' type='color' value='#FF85FF'>
              <input class='NumberInput' type='number' min='1' max='10' placeholder='1-10'>
          ...
          <StyleguideSection onDidInitialize={this.didInitializeSection.bind(this)} name='buttons' title='Buttons'>
            ...
            {this.renderExampleHTML(dedent`
              ...
              <button class='Button Button--primary is-disabled'>Primary</button>
            `)}

            <h2>Button with Icon</h2>
            <p>Overview of all <a href='https://octicons.github.com/'>Octicons</a>.</p>
            {this.renderExampleHTML(dedent`
              <button class='Button'><icon class='icon icon-gear'></icon></button>
              <button class='Button'><icon class='icon icon-cloud-download'></icon><label>Install</label></button>
              <button class='Button Button--primary'><icon class='icon icon-octoface'></icon><label>GitHub</label></button>
            `)}

            <h2>Button Group</h2>
            {this.renderExampleHTML(dedent`
              <div class='ButtonGroup'>
                <button class='ButtonGroup-item Button'>One</button>
                <button class='ButtonGroup-item Button is-selected'>Two</button>
                <button class='ButtonGroup-item Button'>Three</button>
            </div>
            `)}
          </StyleguideSection>
  ...
  renderExampleHTML (html) {
    return (
      <div className='styleguide-Example'>
        <div className='styleguide-Example-rendered' innerHTML={html} />
        <div className='styleguide-Example-code'>
          <CodeBlock cssClass='styleguide-Example-html' grammarScopeName='text.html.basic' code={html} />
        </div>
      </div>
    )
  }
